...
description: 查询本地知识库（repowiki）中的功能归档、技术规格书、API 文档和框架文档。在开始新功能开发、需要查找类似实现、了解现有设计或查询技术规格时使用。
---
...
- 查询结果报告：`orchestrator/PROGRAMS/{current_program}/artifacts/kb-query-result.md`
- 匹配的功能列表、文档片段、技术规格书等
- 复用建议和相关参考链接
...
```
状态：已完成
报告：orchestrator/PROGRAMS/{program_id}/artifacts/kb-query-result.md
匹配数量：{count}
