...
│                                                                             │
│  Phase 2: 需求澄清 + 技术调研                                                 │
│  ├─ Skill: requirement-clarification (主流程)                                │
│  │   → 产出: answers.md, decisions.md                                       │
│  └─ Agent: tech-researcher (并行调研)                                        │
│      → 产出: tech-research-report.md                                        │
│                                                                             │
│  Phase 3: 技术规格书生成                                                      │
│  └─ Agent: doc-generator                                                     │
│     → 产出: tech-spec.md, openapi.yaml, checklist.md                        │
│                                                                             │
│  Phase 4: 代码生成                                                           │
│  └─ Agent: code-generator                                                    │
│     → 产出: Java 源代码, code-generation-report.md                          │
│                                                                             │
│  Phase 5: 测试验证                                                           │
│  └─ Skill: http-test-generation                                              │
│     → 产出: .http 测试文件, SQL 初始化脚本                                   │
│                                                                             │
│  Phase 6: 代码质量检查                                                        │
│  └─ Agent: code-reviewer                                                     │
...
| **Agent 定义**  | `.qoder/agents/README-AGENTS.md`                      | Agent 列表和使用方式    |
| **Skill 定义**  | `.qoder/skills/README-SKILLS.md`                      | Skill 列表和使用方式    |
