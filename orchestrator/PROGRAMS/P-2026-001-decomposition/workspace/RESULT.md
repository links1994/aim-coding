...
### 数据库表
共13张表：aim_agent_employee, aim_agent_job_type, aim_agent_employee_script, aim_knowledge_file, aim_conversation, aim_conversation_message, aim_conversation_report, aim_agent_style_config, aim_agent_product, aim_category_mapping, aim_quota_config, aim_activation_record, aim_agent_script_template
